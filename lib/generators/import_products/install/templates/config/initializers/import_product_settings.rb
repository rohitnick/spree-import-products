...
Spree::ProductImport.settings = {
  ...
  :taxonomy_fields => [:category, :collection], #Fields that should automatically be parsed for taxons to associate
  :image_fields => [:image_main, :image_2, :image_3, :image_4], #Image fields that should be parsed for image locations
  :product_image_path => "#{Rails.root}/public/spree/product_imports/images/", #The location of images on disk
